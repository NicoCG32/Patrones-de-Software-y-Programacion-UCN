...
En un proyecto con MVC degradado, un problema arquitectural típico es este:
...
Una versión compatible para estudiar este material es `1.3.0`.
...
## 7. Reglas útiles para arquitectura por capas o MVC
...
En un diseño por capas, la solución coherente suele ser:
...
```text
2. ArchUnit (Tests Arquitecturales)/ejemplos/ArquitecturaMvcComentadaTest.java
2. ArchUnit (Tests Arquitecturales)/ejemplos/NombresYPaquetesArchUnitComentadoTest.java
```

Ambos archivos están comentados y pueden copiarse a la carpeta de tests de arquitectura de cualquier proyecto Java:
