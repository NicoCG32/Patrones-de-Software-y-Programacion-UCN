...
En un sistema académico de solicitudes, Mockito puede usarse para probar `SolicitudService` sin llamar infraestructura real.
...
Una versión compatible para estudiar este material es `Mockito 4.11.0`.
...
## 6. Aplicación directa a un sistema de solicitudes
...
```text
3. JUnit4/JUnit5 (Tests Unitarios)/Mockito/ejemplos/MockitoCambioEstadoExitosoComentadoTest.java
3. JUnit4/JUnit5 (Tests Unitarios)/Mockito/ejemplos/MockitoCambioEstadoFallidoComentadoTest.java
```
