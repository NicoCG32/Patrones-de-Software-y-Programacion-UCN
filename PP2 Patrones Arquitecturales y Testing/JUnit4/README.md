...
Un test unitario verifica una unidad pequeña de comportamiento en aislamiento razonable. En la Formativa PSP, las unidades más importantes son:
...
## 9. Qué probar en el caso Formativa PSP
...
```text
JUnit4/ejemplos/SolicitudDomainJUnit4ComentadoTest.java
JUnit4/ejemplos/EstadoSolicitudJUnit4ComentadoTest.java
```
...
- Formativa PSP local: tests en `Formativa 2026-I/src/test/java/cl/ucn/solicitudes`.
