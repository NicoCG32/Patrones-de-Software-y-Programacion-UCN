...
```text
4. ProgramacionReactiva/ejemplos/PointToPointSolicitudesComentado.java
```
...
### 5.4. Relación con un sistema de solicitudes

Un sistema de solicitudes puede usar publish-subscribe para el cambio de estado de una solicitud.
...
```text
4. ProgramacionReactiva/ejemplos/PublishSubscribeSolicitudesComentado.java
```
...
```text
4. ProgramacionReactiva/ejemplos/RequestResponseSolicitudesComentado.java
```
...
Aplicado a un sistema de solicitudes:
...
En un ejemplo académico pequeño, un verticle puede guardar historial directamente para simplificar. En un sistema productivo, lo más riguroso sería usar:
...
El Event Bus comunica mensajes. No reemplaza persistencia. Si necesitas auditoría verificable, debes guardar evidencia en un repositorio o adaptador de almacenamiento.
